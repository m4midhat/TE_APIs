...
public class SettingsTest extends B2CBaseTest {
    ...
    @Test(priority = 101, description = "Check location title" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 102, description = "My Account check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 103, description = "Wallet check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 104, description = "Wallet check" , dependsOnMethods = "checkStatus")
    public void CheckWalletURL(){
        String wallet_webURL_Title = jsonPath.getString("data.profile[0].section_list[2].web_url");
        Assert.assertNotNull(wallet_webURL_Title,"Wallet title is null");
    }
    @Test(priority = 105, description = "My Family check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 106, description = "My Friends check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 107, description = "Pings check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 108, description = "Products check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 109, description = "Redemptions check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 110, description = "Orders check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 111, description = "Reservations check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 112, description = "Push Notifications check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 113, description = "Email Preferences check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 114, description = "Onboarding walkthrough check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 115, description = "Help and Support check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 116, description = "Help and Live Chat check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 117, description = "Rules of Use check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 118, description = "Hotel Rules of Use check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 119, description = "About check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 120, description = "End User License Agreement check" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 121, description = "Give us app feedback" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 122, description = "Rate our App" , dependsOnMethods = "checkStatus")
    ...
    @Test(priority = 123, description = "Sign Out check" , dependsOnMethods = "checkStatus")
