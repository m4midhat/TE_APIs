...
public class GetMerchantDetailsTest extends B2CBaseTest {
    ...
    @Test(description = "Time taken by the API should be less than expected time", priority = 1, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Success should be true", priority = 2, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Message should be success", priority = 3, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "data node should be populated", priority = 4, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant id should be populated", priority = 5, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant pin should be populated", priority = 6, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant email address should be populated", priority = 7, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant website should be populated", priority = 8, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant name should be populated", priority = 9, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant description should be populated", priority = 10, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant is_pingable should be populated", priority = 11, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant is_pingable should be populated", priority = 12, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant delivery_contact_number should be populated", priority = 13, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant has_promo_code_offers should be populated", priority = 14, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant category should be populated", priority = 15, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant offer_categories should be populated", priority = 16, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant sub_categories should be populated", priority = 17, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant cuisines should be populated", priority = 18, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant cuisines_sub_categories should be populated", priority = 19, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant merchant_sf_id should be populated", priority = 20, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant is_payless_enabled should be populated", priority = 21, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant is_barcode_enabled should be populated", priority = 22, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant is_barcode_enabled should be populated", priority = 23, dependsOnMethods = "statusCodeShouldBe200")
    ...
    @Test(description = "Merchant show_view_dine_offer_section should be populated", priority = 24, dependsOnMethods = "statusCodeShouldBe200")
